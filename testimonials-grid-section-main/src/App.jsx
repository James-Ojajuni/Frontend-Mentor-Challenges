...
export default function App () {
    return (
        <main className="container">
          ...
          testimonialSummary=" I received a job offer mid-course, and the subjects I learned were current, if not more so, 
          ...
          level="Verified Graduate"
          testimonialSummary="The team was very supportive and kept me motivated"
          ...
          level={`Verified Graduate`}
          testimonialSummary="An overall wonderful and rewarding experience"
          ...
          level={`Verified Graduate`}
          testimonialSummary="Awesome teaching support from TAs who did the bootcamp themselves. Getting guidance from them and 
          ...
          person="Kira Whittle"
          level="Verified Graduate"
          testimonialSummary="Such a life-changing experience. Highly recommended!"
